...
Ce regime permets de simplifier la gestion des impôts en fournissant originellement un seul taux unique d'impôt, basé sur le chiffre d'affaire et effacant toute complexité administrative. Avec les années, quelques impôts séparés ont refait surface dans le regime de micro-entrepreneur, notamment la CFE (cotisation sociale des entreprise) qui est spécifique à votre commune.
...
- Une impossibilité de déduire vos charge de vos impôts. C'est le chiffre d'affaire et non le benefice qui est imposé.

## Impôts et taxes

### La CFE (Cotisation foncière des entreprises)

Pour citer le site [service-public](https://entreprendre.service-public.fr/vosdroits/F23547), dont la définition est plutôt claire:
...
C'est une taxe décidée par la commune, de la même manière que la taxe foncière. Son montant évolue avec les tranches de revenus de l'entreprise (de 200€ passé à plus de 7500€, pour des tranches de 5 000 a 500 000+ euros).
Pour les cas d'exoneration ainsi qu'un montant indicatif de ce montant, je vous invite à visiter le site service [service-public](https://entreprendre.service-public.fr/vosdroits/F23547) ainsi que le site de votre commune/communauté de commune.

### En tant qu'auto-entrepreneur

En tant qu'auto-entrepreneur, le seul impôt hors CFE est basé sur le chiffre d'affaire. Les revenus sont à déclarer auprès de l'URSSAF de manière mensuelle ou trimestriel (ce choix est effectué à la création de l'entreprise ou après modification de ses statuts), il faut y déclarer les revenus dans une des 5 catégories de revenus, imposés sur le **chiffre d'affaire**:
- Achat/revente de marchandises (BIC) (vente de denrées à consommer sur place et de prestations d’hébergement), imposé a 12.3%
- Prestations de services commerciales et artisanales (BIC), imposé a 21.2%
- Autres prestations de services (BNC), imposé a 23.1%
- Professions libérales réglementées relevant de la Cipav (BIC ou BNC), imposé a 23.2%
- Location de meublés de tourisme classés, imposé a 6%

Dans l'informatique, les activités seront en général dans les points 2, 3 et 4.

### En tant qu'entreprise imposée au titre de l'impôt sur le revenu

...

### En tant qu'entreprise imposée au titre de l'impôt sur la société
